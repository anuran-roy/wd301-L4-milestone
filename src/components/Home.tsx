  ...
  return (
    <>
      ...
      >
        <input
          type="text"
          className="my-2 flex-1 border-0 p-2 text-4xl hover:border-b-2 hover:border-b-sky-500 focus:border-b-2 focus:border-b-sky-500 focus:outline-none focus:ring-0"
          value={searchString}
          onChange={(e) => {
